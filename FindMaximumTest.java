...
public class FindMaximumTest {
    ...
    @Test
    //Given 3 String values First String values is Maximum
    public void given3String1stIsMaximum() {
        String[] arrayString = {"Peach","Banana","Apple"};
        Assert.assertEquals("Peach", findMax.findMaximumBetween3Strings(arrayString));
    }
    @Test
    //Given 3 String values Second String values is Maximum
    public void given3String2ndIsMaximum() {
        String[] arrayString = {"Banana","Peach","Apple"};
        Assert.assertEquals("Peach", findMax.findMaximumBetween3Strings(arrayString));
    }
    @Test
    //Given 3 String values  Third String values is Maximum
